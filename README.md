...
| 能力 | 说明 |
|------|------|
| **学习** | 从现有 PPT 提取配色、字体、布局规律，沉淀为可复用的知识库 |
...
用户输入（主题 / 受众 / 风格）
    ...
    ▼
┌─────────────────────────────────────────────┐
│  Knowledge Base        Master Library       │
│  结构 · 图形模式 · 风格规则    品牌主题 · 版式 · 样式资产   │
└──────────────┬──────────────────┬────────────┘
               │                 │
               ▼                 ▼
         Generation Engine
...
│   ├── SKILL.md                   #   操作速查
│   ├── scripts/                   #   共享库与工具脚本
│   │   ├── pptx_lib.py            #     绘图原语 · 渲染器 · BuildContext
│   │   ├── add_slide.py           #     复制/创建幻灯片
│   │   ├── clean.py               #     清理孤立幻灯片
│   │   ├── thumbnail.py           #     缩略图网格生成
│   │   └── office/                #     unpack / pack / soffice 工具
│   ├── knowledge/                 #   场景化知识库
│   │   ├── product-brochure/      #     产品手册风格
│   │   ├── product-architecture/  #     架构图风格
│   │   └── ...                    #     更多场景
│   └── master-library/            #   母版资产库
├── projects/                      # 生成项目（演示 & 实战）
│   ├── ppt-maker-intro-cloudwise-2025/  # Cloudwise 自我介绍（模板生成）
│   ├── business-process-full-deck/      # 业务流程泳道图
│   ├── capability-map-test/             # 能力矩阵图
│   └── ...
└── output/                        # 生成产物与学习产物
```
